...
echo "$($PSQL "SELECT DISTINCT t1.name FROM teams t1 JOIN games g1 ON t1.team_id = g1.winner_id OR t1.team_id = g1.opponent_id WHERE g1.year = 2014 AND g1.round = 'Eighth-Final' ORDER BY t1.name")"
